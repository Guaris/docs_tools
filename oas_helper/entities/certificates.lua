...
local description = [[
  test test are abstractions of of individual upstream services. Examples of Services would be a data transformation microservice, a billing API, etc.
...
return {
  ...
  fields = {
    ...
    { key_alt    = typedefs.key         { required = false, referenceable = true, encrypted = true, description: "test test" }, },
    { tags       = typedefs.tags },
  },
